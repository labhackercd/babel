# Generated by Django 2.0.2 on 2018-02-08 16:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('channel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='collect_domain_attrs', to='core.Channel')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(max_length=150)),
                ('is_mandatory', models.BooleanField(default=False)),
                ('channel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='profile_domain_attrs', to='core.Channel')),
            ],
            options={
                'verbose_name': 'Profile Domain Attribute',
                'verbose_name_plural': 'Profile Domain Attributes',
            },
        ),
        migrations.AddField(
